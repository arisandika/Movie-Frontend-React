...
const ComingSoon = () => {
  ...
  return (
    <section className="mt-8">
      ...
      <div className="flex gap-6 overflow-x-auto snap-x snap-mandatory cm-soon-scrollbar">
        {items.map((item, index) => (
          <div
            key={index}
            className="relative min-w-[80%] md:min-w-[60%] aspect-[4/5] md:aspect-[16/9] rounded-xl snap-center overflow-hidden mb-6"
          >
            <img
              src={item.src}
              alt={item.title}
            ...
            />
            <div
              className="absolute bottom-0 flex items-center justify-center w-full p-5 text-white"
            >
